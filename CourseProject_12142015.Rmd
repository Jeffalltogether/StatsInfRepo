...
mapping the normal distribution to this figure.

From the following figure, we can tell that the histogram approximates a normal
distribution.
...
The same principle applied to the distribution of variances.  

```{r fig.width=3.5, fig.height=2.5, echo=FALSE}
Vstdev <- sd(DFvar[,2])

ggplot(DFvar, aes(x=Variance)) + 
        geom_histogram(aes(y=..density..),fill = "darkorchid2", color = "black", size = 0.2, binwidth=1) +
